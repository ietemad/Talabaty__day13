      ...
      Center(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Image.asset("image/order.png",
                  height: MediaQuery.of(context).size.height/3,
                  width: MediaQuery.of(context).size.width/2,
                ),
                Text("قم بتسجيل الدخول لعرض طلباتك السابة",
          ...
          children: [
            ...
            GestureDetector(
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset("image/billr.png", height: Is(), width: Is(),),
            ...
            GestureDetector(
              child:Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Icon(Icons.home, color: Color(0xffbdbdbd), size: Is(),),
